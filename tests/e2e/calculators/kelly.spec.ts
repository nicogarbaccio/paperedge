...
test.describe('Kelly Criterion Calculator', () => {
  ...
  test('should validate input fields', async ({ page }) => {
    // Fill required fields first so we don't hit "empty fields" error
    ...
    // Should show specific error message for bankroll
    // Note: The exact text might vary, checking for substring
